...
1. Install chart using
   ...
   Example:
    ...
    ```console
    helm install my-senzing-entity-search-web-app senzing/senzing-entity-search-web-app
    ```

    The command deploys `senzing-entity-search-web-app` on the Kubernetes cluster in the default configuration.
...
1. Uninstall/delete the deployment using
   ...
   Example:
    ...
    ```console
    helm uninstall my-senzing-entity-search-web-app
    ```
...
The above parameters map to the env variables defined in [bitnami/senzing-entity-search-web-app](http://github.com/bitnami/bitnami-docker-%%CHART_NAME%%). For more information please refer to the [bitnami/senzing-entity-search-web-app](http://github.com/bitnami/bitnami-docker-%%CHART_NAME%%) image documentation.
...
The above command sets the senzing-entity-search-web-app administrator account username and password to `admin` and `password` respectively. Additionally, it sets the MariaDB `root` user password to `secretpassword`.
...
```console
helm install my-senzing-entity-search-web-app -f values.yaml senzing/senzing-entity-search-web-app
```
