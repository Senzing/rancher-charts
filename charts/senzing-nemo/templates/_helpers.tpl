...
*/}}
{{- define "senzing-nemo.volumePermissions.image" -}}
...
*/}}
{{- define "senzing-nemo.imagePullSecrets" -}}
...
*/}}
{{- define "senzing-nemo.serviceAccountName" -}}
...
*/}}
{{- define "senzing-nemo.validateValues" -}}
{{- $messages := list -}}
