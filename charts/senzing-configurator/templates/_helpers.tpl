...
*/}}
{{- define "senzing-configurator.image" -}}
...
*/}}
{{- define "senzing-configurator.volumePermissions.image" -}}
...
*/}}
{{- define "senzing-configurator.imagePullSecrets" -}}
...
*/}}
{{- define "senzing-configurator.serviceAccountName" -}}
...
*/}}
{{- define "senzing-configurator.ingress.certManagerRequest" -}}
...
*/}}
{{- define "senzing-configurator.validateValues" -}}
{{- $messages := list -}}
