...
*/}}
{{- define "senzing-api-server.image" -}}
...
*/}}
{{- define "senzing-api-server.volumePermissions.image" -}}
...
*/}}
{{- define "senzing-api-server.imagePullSecrets" -}}
...
*/}}
{{- define "senzing-api-server.ingress.certManagerRequest" -}}
...
*/}}
{{- define "senzing-api-server.serviceAccountName" -}}
...
*/}}
{{- define "senzing-api-server.validateValues" -}}
{{- $messages := list -}}
