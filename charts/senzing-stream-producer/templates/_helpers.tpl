...
*/}}
{{- define "senzing-stream-producer.image" -}}
...
*/}}
{{- define "senzing-stream-producer.volumePermissions.image" -}}
...
*/}}
{{- define "senzing-stream-producer.ingress.certManagerRequest" -}}
...
*/}}
{{- define "senzing-stream-producer.validateValues" -}}
{{- $messages := list -}}
