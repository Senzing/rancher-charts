...
*/}}
{{- define "senzing-apt.volumePermissions.image" -}}
...
*/}}
{{- define "senzing-apt.imagePullSecrets" -}}
...
*/}}
{{- define "senzing-apt.serviceAccountName" -}}
...
*/}}
{{- define "senzing-apt.ingress.certManagerRequest" -}}
...
*/}}
{{- define "senzing-apt.validateValues" -}}
{{- $messages := list -}}
