...
1. Install chart using
   ...
   Example:
    ...
    ```console
    helm install my-senzing-init-container senzing/senzing-init-container
    ```

    The command deploys `senzing-init-container` on the Kubernetes cluster in the default configuration.
...
1. Uninstall/delete the deployment using
   ...
   Example:
    ...
    ```console
    helm uninstall my-senzing-init-container
    ```
...
The above parameters map to the env variables defined in [bitnami/senzing-init-container](http://github.com/bitnami/bitnami-docker-%%CHART_NAME%%). For more information please refer to the [bitnami/senzing-init-container](http://github.com/bitnami/bitnami-docker-%%CHART_NAME%%) image documentation.
...
The above command sets the senzing-init-container administrator account username and password to `admin` and `password` respectively. Additionally, it sets the MariaDB `root` user password to `secretpassword`.
...
```console
helm install my-senzing-init-container -f values.yaml senzing/senzing-init-container
```
