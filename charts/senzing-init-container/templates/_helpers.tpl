...
*/}}
{{- define "senzing-init-container.image" -}}
...
*/}}
{{- define "senzing-init-container.volumePermissions.image" -}}
...
*/}}
{{- define "senzing-init-container.ingress.certManagerRequest" -}}
...
*/}}
{{- define "senzing-init-container.serviceAccountName" -}}
...
*/}}
{{- define "senzing-init-container.validateValues" -}}
{{- $messages := list -}}
