...
*/}}
{{- define "senzing-redoer.volumePermissions.image" -}}
...
*/}}
{{- define "senzing-redoer.imagePullSecrets" -}}
...
*/}}
{{- define "senzing-redoer.serviceAccountName" -}}
...
*/}}
{{- define "senzing-redoer.ingress.certManagerRequest" -}}
...
*/}}
{{- define "senzing-redoer.validateValues" -}}
{{- $messages := list -}}
